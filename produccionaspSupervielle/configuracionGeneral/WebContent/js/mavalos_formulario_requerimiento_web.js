...
$(document).ready(
		function() {
			...
			//Modifica Adrian , deja Elejir usuario en caso de ser Centralizacion de Supervielle 
				var codPers = $("#codigoPersonal").val();
				if (codPers == "5077"){
			...
			if($("#tipoRequerimientoCod").val() != null && ($("#accion").val()!=null &&  $("#accion").val()!='CONSULTA')) {
