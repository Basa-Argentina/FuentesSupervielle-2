...
$(document).ready(function(){
	...
	$("#importar").click(function(){
		...
		if(cl!=""){
			...
			document.location="importarLecturaPosicionLibreCambioEtiqueta.html?codigoLectura="+cl;
		}
	});
	...
	$("#historial").click(function(){
		...
		if(cl!=""){
				parent.$.fancybox({
					...
					'type'				: 'iframe',
					onCleanup : function(){  
						return document.location = 'iniciarPrecargaFormularioCambioEtiqueta.html';
						
						
					},
					'href'				: 'mostrarHistorialCambioEtiqueta.html?idLectura='
						+cl
				});
		}
	});
	...
	$("#generarEtiqueta").click(function(){
		// validar que sea del mismo tipo los elementos
		var bandera = false;
		var tipoElemento = null;
	    $("input[class='elementoClass']:input").each(function() {
	    	if(tipoElemento == null){
	    		tipoElemento = $(this).val();
	    	}else{
	    		if(tipoElemento!=$(this).val()){
	    			bandera = true;
	    		}
	    	}		
	    ...
	    if(bandera == true){
	    	jAlert('Debe importar elementos del mismo tipo.');
			return;
		}else{
	    	document.location="guardarCambioEtiqueta.html";
	    }
	});
