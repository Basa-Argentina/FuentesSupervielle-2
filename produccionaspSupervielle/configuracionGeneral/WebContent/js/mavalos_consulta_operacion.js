...
$(document).ready(function() {
	...
	$('#cambiarEstado').click(function(){
	    ...
	    if($('#codigoResponsable').val()==""){
	    	jAlert('Debe seleccionar un responsable.');
			return;
	    }
	    if(allVals.length == 0)
	    {
	    ...
	    else
		{
	    	...
	    	document.getElementById("cambiarUsuarioAsignado").submit();
	    }
	});
  ...
  //binding OnBlur() para los campos con popup
	...
	$("#codigoRequerimiento").blur(function(){
		searchAjaxReq('seleccionRequerimientoNumero.html','codigoRequerimiento','codigoSucursal','codigoEmpresa',getRequerimientoCallBack);
	});
	...
	$("#buscaRequerimiento").click(function(){
		abrirPopupSeleccionRequerimiento("popUpSeleccionRequerimientoNumero.html","codigoSucursal","codigoEmpresa","requerimientosPopupMap", $("#mensajeSeleccioneEmpresa").val());
	});
...
function consultar(id){
	if(id!=null)
		document.location="iniciarOperacionReferencia.html?idOperacion="+id;
}
