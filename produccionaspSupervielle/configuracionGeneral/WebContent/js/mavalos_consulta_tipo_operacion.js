...
function agregar(){
	document.location="precargaFormularioTipoOperacion.html";
}
function consultar(id){
	if(id!=null)
		document.location="precargaFormularioTipoOperacion.html?accion=CONSULTA&id="+id;
}
function modificar(id){
	if(id!=null)
		document.location="precargaFormularioTipoOperacion.html?accion=MODIFICACION&id="+id;
}
function eliminar(mensaje, id){
	if(id!=null && id!=undefined && mensaje!=undefined){
		jConfirm(mensaje, 'Confirmar Eliminar',function(r) {
		    if(r){
		    	document.location="eliminarTipoOperacion.html?id="+id;
		    }
		});		
	}
}
