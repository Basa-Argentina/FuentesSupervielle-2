...
<html>
	<head>
		...
		<title>
			<spring:message code="formularioFactura.aviso.impresion" htmlEscape="true"/>
		</title>
...
<div style="width: 100%">
	...
	<div id="menu">
		...
		<div id="darkLayer" class="darkClassWithoutHeight"></div>		
		<jsp:include page="fieldErrors.jsp"/>
		<jsp:include page="fieldAvisos.jsp"/>
		<div id="pop" class="darkClassWithoutHeight">
			<img src="<%=request.getContextPath()%>/images/wait.gif" border="0" width="20px" height="20px">
			<label style="font-weight: bold;">Generando facturas. Espere por favor...</label>	     
		</div>
	</body>
</html>