...
<html>
	<head>
		...
		<title>
			<spring:message code="formularioSucursal.titulo" htmlEscape="true"/>
		</title>
		<script type="text/javascript" src="js/jquery-1.5.js"></script>
		<script type="text/javascript" src="js/jquery.contextmenu.js"></script>
		<script type="text/javascript" src="js/mavalos_jquery.tools.min.js" language="JavaScript"></script>
		<script type="text/javascript" src="js/mavalos_consulta_sucursal.js"></script>
		...
		<div class="contextMenu" id="myMenu1">
	  	...
	  	<div id="contenedorGeneral">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
					...
					<br/>
					<form:form action="filtrarSucursal.html" commandName="sucursalBusqueda" method="post">
						<fieldset>
							<table width="100%">
				            	<thead>
					            	<tr>
							...
							<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"  id="busquedaDiv" align="center">
								<table class="busqueda" style="width: 100%; background-color: white;">
									<tr>
										<td class="texto_ti">
											<spring:message code="formularioSucursal.datosSucursal.empresa" htmlEscape="true"/>
										</td>
										<td class="texto_ti">
											<spring:message code="formularioSucursal.datosSucursal.codigo" htmlEscape="true"/>
										</td>
										<td class="texto_ti">
											<spring:message code="formularioSucursal.nombreSucursal" htmlEscape="true"/>
										</td>										
									...
									<tr>
											...
											<select id="idEmpresa"
													...
													<c:forEach items="${empresas}" var="empresa">
														<option value="${empresa.id}"
															<c:if test="${empresa.id == sucursalBusqueda.empresa.id}">
															selected="selected"
														</c:if>>
										...
										<td class="texto_ti">
											<input type="text" id="codigo" name="codigo" style="width: 200px;"
												value="<c:out value="${sucursalBusqueda.codigo}" default="" />"/>
										</td>										
										<td class="texto_ti">
											<input type="text" id="descripcion" name="descripcion" style="width: 200px;"
												value="<c:out value="${sucursalBusqueda.descripcion}" default="" />"/>
										</td>										
									</tr>
								</table>
							</div>	
					...
					<fieldset>
						<display:table name="sucursales" id="sucursal" requestURI="mostrarSucursal.html" pagesize="20" sort="list" keepStatus="true">
							<display:column class="hidden" headerClass="hidden">
							    <input type="hidden" id="hdn_id" value="${sucursal.id}"/>
			              	</display:column>		
			              	<display:column class="hidden" headerClass="hidden">
						    	<input type="hidden" id="hdn_eliminar" value="<spring:message code="mensaje.eliminar" htmlEscape="true"/>"/>
		           		   	</display:column>
		           		   	<display:column property="empresa.descripcion" titleKey="formularioSucursal.datosSucursal.empresa" sortable="true" class="celdaAlineadoIzquierda"/>
							<display:column property="codigo" titleKey="formularioSucursal.datosSucursal.codigo" sortable="true" class="celdaAlineadoIzquierda"/>
						  	<display:column property="descripcion" maxLength="30" titleKey="formularioSucursal.nombreSucursal" sortable="true" class="celdaAlineadoIzquierda"/>						  							  	
