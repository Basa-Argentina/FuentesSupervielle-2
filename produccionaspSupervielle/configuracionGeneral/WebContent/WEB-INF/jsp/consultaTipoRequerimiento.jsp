...
<html>
	<head>
		...
		<script type="text/javascript" src="js/mavalos_consulta_tipo_requerimiento.js"></script>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
					<legend>
			        	<font class="tituloForm" size="5">
			        		<spring:message code="formularioTipoRequerimiento.titulo" htmlEscape="true"/>		        		
		        		</font>		  
					</legend>
					<br/>
					<form:form action="filtrarTipoRequerimiento.html" modelAttribute="tipoRequerimientoBusqueda" method="post">
						<fieldset>
							<table width="100%">
				            	<thead>
					            	<tr>
									...
									<tr>					
										...
										<td class="texto_ti">
											<input type="text" id="codigo" name="codigo" style="width: 150px;"
												value="<c:out value="${tipoRequerimientoBusqueda.codigo}" default="" />"/>
										</td>	
										<td class="texto_ti">
										...
										<td class="texto_ti">
											<input type="text" id="descripcion" name="descripcion" style="width: 150px;"
												value="<c:out value="${tipoRequerimientoBusqueda.descripcion}" default="" />"/>
										</td>
										<td class="texto_ti">
											<spring:message code="formularioTipoRequerimiento.filtro.plazo" htmlEscape="true"/>
										</td>
										<td class="texto_ti">
											<input type="text" id="plazo" name="plazo" style="width: 150px;"
												value="<c:out value="${tipoRequerimientoBusqueda.plazo}" default="" />"/>
										</td>							
					...
					<fieldset>
						<display:table name="tipos" id="tipo" requestURI="mostrarTipoRequerimiento.html" pagesize="20" sort="list" keepStatus="true">
							<display:column class="hidden" headerClass="hidden">
						  	...
						  	<display:column property="codigo" titleKey="formularioConceptoFacturable.filtro.codigo" sortable="true" class="celdaAlineadoIzquierda upperCase"/>
						  	...
						  	<display:column titleKey="formularioTipoRequerimiento.filtro.plazo" sortable="true" class="celdaAlineadoDerecha">
						  		<c:out value="${tipo.plazo}"></c:out>
						  	</display:column>					  	 	
