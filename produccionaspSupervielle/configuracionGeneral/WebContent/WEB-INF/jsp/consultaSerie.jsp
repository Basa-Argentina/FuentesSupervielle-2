...
<html>
	<head>
		...
		<title>
			<spring:message code="formularioSerie.titulo" htmlEscape="true"/>
		</title>
		<script type="text/javascript" src="js/jquery-1.5.js"></script>
		<script type="text/javascript" src="js/jquery.contextmenu.js"></script>
		<script type="text/javascript" src="js/mavalos_jquery.tools.min.js" language="JavaScript"></script>
		<script type="text/javascript" src="js/mavalos_consulta_serie.js"></script>
		...
		<div class="contextMenu" id="myMenu1">
	  	...
	  	<div id="contenedorGeneral">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
					...
					<br/>
					<form:form action="filtrarSerie.html" commandName="serieBusqueda" method="post">
						<fieldset>
							<table width="100%">
				            	<thead>
					            	<tr>
							...
							<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"  id="busquedaDiv" align="center">
								<table class="busqueda" style="width: 100%; background-color: white;">
									<tr>
										<td class="texto_ti">
											<spring:message code="formularioSerie.datosSerie.codigo" htmlEscape="true"/>
										</td>
										<td class="texto_ti">
											<spring:message code="formularioSerie.nombreSerie" htmlEscape="true"/>
										</td>
									...
									<tr>
										<td class="texto_ti">
											<input type="text" id="codigo" name="codigo" style="width: 200px;"
												value="<c:out value="${serieBusqueda.codigo}" default="" />"/>
										</td>										
										<td class="texto_ti">
											<input type="text" id="descripcion" name="descripcion" style="width: 200px;"
												value="<c:out value="${serieBusqueda.descripcion}" default="" />"/>
										</td>
									</tr>
								</table>
							</div>	
					...
					<fieldset>
						<display:table name="series" id="serie" requestURI="mostrarSerie.html" pagesize="20" sort="list" keepStatus="true">
							<display:column class="hidden" headerClass="hidden">
							    <input type="hidden" id="hdn_id" value="${serie.id}"/>
			              	</display:column>		
			              	<display:column class="hidden" headerClass="hidden">
						    	<input type="hidden" id="hdn_eliminar" value="<spring:message code="mensaje.eliminar" htmlEscape="true"/>"/>
		           		   	</display:column>
		           		   	<display:column property="tipoSerie" titleKey="formularioSerie.datosSerie.tipoSerie" sortable="true" class="celdaAlineadoIzquierda"/>
							<display:column property="codigo" titleKey="formularioSerie.datosSerie.codigo" sortable="true" class="celdaAlineadoIzquierda"/>
						  	<display:column property="descripcion" titleKey="formularioSerie.nombreSerie" sortable="true" class="celdaAlineadoIzquierda"/>
						  	<display:column property="empresa.descripcion" titleKey="formularioSerie.datosSerie.empresa" sortable="true" class="celdaAlineadoIzquierda"/>
						  	<display:column property="sucursal.descripcion" titleKey="formularioSerie.datosSerie.sucursal" sortable="true" class="celdaAlineadoIzquierda"/>						  	
