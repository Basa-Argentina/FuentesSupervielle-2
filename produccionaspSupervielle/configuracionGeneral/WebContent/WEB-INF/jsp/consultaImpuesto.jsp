...
<html>
	<head>
		...
		<title>
			<spring:message code="formularioImpuesto.titulo" htmlEscape="true"/>
		</title>
		<script type="text/javascript" src="js/jquery-1.5.js"></script>
		<script type="text/javascript" src="js/jquery.contextmenu.js"></script>
		<script type="text/javascript" src="js/mavalos_jquery.tools.min.js" language="JavaScript"></script>
		<script type="text/javascript" src="js/mavalos_consulta_impuesto.js"></script>
		<script type="text/javascript" src="js/ini.js" language="JavaScript"></script>
		<script type="text/javascript" src="js/calendar_us.js" language="JavaScript"></script>
		<script type="text/javascript" src="js/jquery.alerts.js"></script>
	</head>
	<body onload="mostrarErrores(${errores}); mostrarAvisos(${hayAvisos})">
		<div class="contextMenu" id="myMenu1">
	  	...
	  	<div id="contenedorGeneral">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
					...
					<br/>
					<form:form action="filtrarImpuesto.html" commandName="impuestoBusqueda" method="post">
						<fieldset>
							<table width="100%">
				            	<thead>
					            	<tr>
									...
									<tr>					
										...
										<td class="texto_ti">
											<input type="text" id="codigo" name="codigo" style="width: 150px;"
												value="<c:out value="${impuestoBusqueda.codigo}" default="" />"/>
										</td>	
										<td class="texto_ti">
										...
										<td class="texto_ti">
											<input type="text" id="descripcion" name="descripcion" style="width: 150px;"
												value="<c:out value="${impuestoBusqueda.descripcion}" default="" />"/>
										</td>										
					...
					<fieldset>
						<display:table name="impuestos" id="impuesto" requestURI="mostrarImpuesto.html" pagesize="7" sort="list" keepStatus="true">
							<display:column class="hidden" headerClass="hidden">
							    <input type="hidden" id="hdn_id" value="${impuesto.id}"/>
			              	</display:column>		
			              	<display:column class="hidden" headerClass="hidden">
						    	<input type="hidden" id="hdn_eliminar" value="<spring:message code="mensaje.eliminar" htmlEscape="true"/>"/>
		           		   	</display:column>					  	
						  	<display:column property="codigo" titleKey="formularioImpuesto.filtro.codigo" sortable="true" class="celdaAlineadoIzquierda"/>
						  	<display:column property="descripcion" titleKey="formularioImpuesto.filtro.descripcion" sortable="true" class="celdaAlineadoIzquierda"/>
						  	<display:column property="tipo" titleKey="formularioImpuesto.tabla.tipo" sortable="true" class="celdaAlineadoIzquierda"/>						  	
						  	<display:column property="alicuota" titleKey="formularioImpuesto.tabla.alicuota" sortable="true" class="celdaAlineadoDerecha">
						  		<fmt:formatNumber value="${generalPayment.exchangeRate}" />						 
						  	</display:column>	 	
