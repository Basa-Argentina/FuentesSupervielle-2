...
<script type="text/javascript" src="js/mavalos_consulta_requerimiento_web.js"></script>
	...
	<div id="contenedorGeneral">
		...
		<div class="contenido" align="left">
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
				...
				<br />
				<form:form action="filtrarRequerimientoWeb.html" name="formBusqueda"
							...
							<table class="busqueda"
								...
								<tr>
									...
									<td class="texto_ti" colspan="3">
											...
											<c:if test="${permiteCambiarPersonal==null || permiteCambiarPersonal==false}">
												readonly="readonly" 
											</c:if>
											/>
								...
								<tr>
									<td class="texto_ti" colspan="3"><input type="text" id="clienteCodigo"
										...
										<c:if test="${bandera==null || bandera==false}">
											readonly="readonly"
										</c:if>
										/>
										&nbsp;&nbsp;
				...
				<fieldset>
					<display:table name="requerimientos" id="requerimiento"  pagesize="20" sort="external" requestURI="mostrarRequerimiento.html"
						...
						<div style="width: 100%" align="right">
							<button name="agregar" type="button"
								onclick="agregarRequerimiento();" class="botonCentrado">
