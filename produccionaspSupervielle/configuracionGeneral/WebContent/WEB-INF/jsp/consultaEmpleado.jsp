...
<html>
	<head>
		...
		<title><spring:message code="formularioEmpleado.tituloConsulta" htmlEscape="true"/> - <spring:message code="general.empresa" htmlEscape="true"/> <spring:message code="general.ambiente" htmlEscape="true"/></title>
			...
			<fieldset style="border: none; text-align: left; width: 97%;">
					<legend>
			        	<font class="tituloForm" size="5">
			        		<spring:message code="formularioEmpleado.tituloConsulta" htmlEscape="true"/>		        		
		        		</font>		  
					</legend>
					<br/>
					<form:form action="filtrarEmpleado.html" commandName="empleadoBusqueda" method="get">
						<fieldset>
							<table width="100%">
				            	<thead>
					            	<tr>
							...
							<div style="background-color: #f1e87d; WIDTH: auto; DISPLAY: none"  id="busquedaDiv" align="center">
								<table class="busqueda" style="width: 100%; background-color: white;">
									<tr>	
										<td class="texto_ti">
											<spring:message code="formularioEmpleado.cliente" htmlEscape="true"/>
										</td>	
										<td class="texto_ti">
											<spring:message code="formularioEmpleado.username" htmlEscape="true"/>
										</td>
										<td class="texto_ti">
											<spring:message code="formularioEmpleado.firstName" htmlEscape="true"/>
										</td>
										<td class="texto_ti">
											<spring:message code="formularioEmpleado.surName" htmlEscape="true"/>
										</td>
					...
					<fieldset>
						<display:table name="empleados" id="empleado" requestURI="" pagesize="7" sort="list" keepStatus="true">
							<display:column class="hidden" headerClass="hidden">
			              	...
			              	<display:column class="hidden" headerClass="hidden">
						    	<input type="hidden" id="hdn_eliminar" value="<spring:message code="mensaje.eliminar" htmlEscape="true"/>"/>
		           		   	...
		           		   	<display:column maxLength="10" style="width:40px;" property="codigo" titleKey="formularioEmpleado.datosEmpleado.codigo" sortable="true" class="celdaAlineadoIzquierda"/>
						  	<display:column maxLength="60" style="width:200px;" property="usernameSinCliente" titleKey="formularioEmpleado.username" sortable="true" class="celdaAlineadoIzquierda"/>						  	
						  	<display:column property="persona.nombre" style="width:300px;"  titleKey="formularioEmpleado.firstName" sortable="true" class="celdaAlineadoIzquierda"/>						  	
						  	<display:column property="persona.apellido" style="width:300px;" titleKey="formularioEmpleado.surName" sortable="true" class="celdaAlineadoIzquierda"/>						  	
	  					  	<display:column titleKey="formularioEmpleado.enabled" sortable="true" class="celdaAlineadoCentrado">
							 	 ...
							 	 <c:if test="${empleado.admin != true}">
								 	 <c:if test="${empleado.habilitado != null && empleado.habilitado == true}">
									 	<img src="<%=request.getContextPath()%>/images/habilitado.png" 
							  		...
							  		<c:if test="${empleado.habilitado == null || empleado.habilitado == false}">
						...
						<div style="width: 100%" align ="right">
							<button name="agregar" type="button" onclick="agregarEmpleado();" class="botonCentrado">
