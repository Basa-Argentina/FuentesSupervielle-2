...
<jsp:include page="styles.jsp" />
	<title> 
		...
		<script type="text/javascript" src="js/mavalos_consulta_provincias.js"></script>
	...
	<table style="width: 100%; border-spacing: 0px;">
		<tr>
			<td style="width: 33%; vertical-align: top;">
				<form:form action="filtrarProvincias.html" commandName="provinciaBusqueda" method="post">
										<fieldset>
											<table width="100%">
							            	<thead>
								            	<tr>
								              		<th align="left" id="busquedaImg" >						  
										        		<font style="color:#003090">
										        			<spring:message code="formularioLugares.buscarProvincias" htmlEscape="true"/>
										        		</font>
											...
											<table class="busqueda" style="width: 100%; background-color: white;">
												<tr>					
													<td class="texto_ti">
														...
														<input type="hidden" id="paisId" name="paisId" style="width: 150px;"
															value="<c:out value="${provinciaBusqueda.pais.id}" default="" />"/>
													</td>
												</tr>
												<tr>	
													<td class="texto_ti">
														<input type="text" id="id" name="id" style="width: 150px;"
															value="<c:out value="${provinciaBusqueda.id}" default="" />"/>
													</td>
												</tr>
												<tr>
													<td class="texto_ti">
												...
												<tr>	
													<td class="texto_ti">
														<input type="text" id="nombre" name="nombre" style="width: 150px;"
															value="<c:out value="${provinciaBusqueda.nombre}" default="" />"/>
													</td>
												</tr>
												<tr>										
				...
				<table width="100%;">
		           	<thead>
		            	<tr>
		              		<th align="left">						  
				        		<font style="color:#003090">
				        			<spring:message code="formularioLugares.provincias" htmlEscape="true"/>
				        		</font>						        						 
		              		</th>
					 	</tr>
					</thead>
				</table>
				<div class="displayTagDiv" style="text-align: left; height: 80%;">
					<display:table name="paisSel.provincias" id="provincia" requestURI="mostrarProvincias.html" pagesize="10" sort="list" keepStatus="true" defaultsort="4">
						<display:column class="hidden" headerClass="hidden">
						    <input type="hidden" id="hdn_id" value="${provincia.id}"/>
		              	</display:column>		
		              	<display:column class="hidden" headerClass="hidden">
					    	<input type="hidden" id="hdn_eliminar" value="<spring:message code="formularioLugares.mensaje.eliminarProvincia" htmlEscape="true"/>"/>
		          		   	</display:column>					  	
						...
						<display:column class="hidden" headerClass="hidden">
						    <input type="hidden" id="hdn_idPais" value="${provincia.pais.id}"/>
		              	</display:column>
					</display:table>
				</div>
				<br>
					<div style="width: 100%" align ="center">
							<input type="hidden" id="idPais" name="idPais"
								value="<c:out value="${paisSel.id}" default="" />"/>
							<input type="hidden" id="accion" name="accion"
								value="<c:out value="${accion}" default="" />"/>
							<input type="hidden" id="codigo" name="codigo"
								value="<c:out value="${pciaFormulario.id}" default="" />"/>
							<input type="text" id="nuevo" name="nuevo" size="32"
								value="<c:out value="${pciaFormulario.nombre}" default="" />"/>
			...
			<td style="width: 66%; vertical-align: top;">
				<iframe src="mostrarLocalidades.html" id="iframeLocalidades" frameborder="0" height="680px" width="98%" ></iframe>
			</td>
		</tr>
	</table>	 
