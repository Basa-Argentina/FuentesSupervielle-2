...
<html>
	<head>
		...
		<script type="text/javascript" src="js/mavalos_formulario_requerimiento_web.js"></script>
    </head>		
		...
		<div id="contenedorGeneral">
			...
			<div class="contenido" align="left">
				...
				<fieldset style="border: none; text-align: left; width: 97%;">
					...
					<br/>
					<form:form action="guardarActualizarRequerimientoWeb.html" modelAttribute="requerimientoFormulario" method="post">
						...
						<input type="hidden" name="insertarElementoDirecto" id="insertarElementoDirecto" value=false></input>
						...
						<input type="hidden" id="mensajeSeleccioneTipoReq" name="mensajeSeleccioneTipoReq" value="<spring:message code="notif.seleccion.seleccionTipoReq" htmlEscape="true"/>"/>
						<fieldset>
							<table width="100%">
				            	<thead>
					            	<tr>
							...
							<div style="width: 100%;" id="busquedaDiv" align="center">
								<table>
									...
									<tr>	
										...
										<td class="texto_ti"  style="width: 350px;" colspan="2">														
											...
											<input id="codigoDeposito" type="text"  class="hidden" name="codigoDeposito" maxlength="6" style="width: 50px;" value="10" />
									...
									<tr>
										...
										<td>
																		<input type="text" id="cantidad" name="cantidad" size="4" maxlength="4" class="integer"
																		<c:if test="${accion == 'CONSULTA'}">readonly="readonly"</c:if>
																			value="<c:out value="${requerimientoFormulario.cantidad}" />"
																		/>	
																	</td>	
									</tr>
									<tr>
										<td style="text-align: left;" colspan="8">											
											<table style="width: 100%;">													
													...
													<td colspan="2" style="width: 100%;">
														...
														<legend>
																		...
																		<c:if test="${accion != 'MODIFICACION'}">
																			<c:if test="${listaConElementos == null || listaConElementos == 'NO'}">
																				...
																				<button type="button" name="buscaCliente" id="buscaCliente"
																					title="<spring:message code="textos.buscar" htmlEscape="true"/>"
																						<c:if test="${bandera == null || bandera != true || accion=='CONSULTA'}">
																							disabled="disabled"
																						</c:if>>
																					<img src="<%=request.getContextPath()%>/images/buscar.png">
																				</button>&nbsp;&nbsp; 
																			...
																			value="<c:out value="${requerimientoFormulario.codigoPersonal}" default="" />"
																			 ...
																			 <c:if test="${accion != 'MODIFICACION'}">
																				...
																				for="codigoPersonal">
																				 ...
																				 <%-- <c:out value="${requerimientoFormulario.empleadoSolicitante.nombreYApellido}"default="" />  --%>
																				 </label>
															...
															<table>												
																<tr>
																	<td>
																	<label id="labelobs" for="labelobs" style="width: 150px;">
																	<c:out value="Observaciones" default="" />
																	</label>
																	<label id="labelobs1" for="labelobs1" style="width: 150px;" >
																	<c:out value="Indica los numeros de caja: " default="" />
																	</label>
																...
																<tr>
																	<td>
																	<%-- luis <textarea id="observaciones" name="observaciones" rows="12" cols="60" --%>
																		<textarea id="observaciones" name="observaciones" rows="9" cols="60"  maxlength="2000"
																		<c:if test="${accion == 'CONSULTA'}">readonly="readonly"</c:if>>
												...
												<tr id="trInsertarElemento" class="hidden">
													<td class="texto_ti">
														Elemento:
													 	<%-- <input type="text" id="codigoElemento" name="codigoElemento" value = "110000136211" maxlength="12" class="integer"  --%>
													 	<input type="text" id="codigoElemento" name="codigoElemento"  maxlength="12" class="integer" 
													 		<c:if test="${accion == 'CONSULTA'}">readonly="readonly"</c:if>>
																&nbsp;&nbsp;
														<button id="btnInsertarElementoDirecto" name="btnInsertarElementoDirecto" type="button" >
							...
							<c:if test="${accion == 'NUEVO'}">
								<div style="width: 100%" align="right">
									<table>
										<tr>
											<td>
											<!-- luis <button id="buscarElementos" name="buscarElementos"  visility = hiden onclick="buscarElementosSinReferencia('<spring:message code="notif.seleccion.seleccionCliente" htmlEscape="true"/>')"
													type="button">
													<img src="<%=request.getContextPath()%>/images/buscar.png">
											...
											<td>
												<!--  luis  <button id="buscarElementosReferencias" name="buscarElementosReferencias" visility = hiden onclick="buscarElementosReferencia('<spring:message code="notif.seleccion.seleccionCliente" htmlEscape="true"/>')"
													type="button">
													<img src="<%=request.getContextPath()%>/images/buscar.png">
