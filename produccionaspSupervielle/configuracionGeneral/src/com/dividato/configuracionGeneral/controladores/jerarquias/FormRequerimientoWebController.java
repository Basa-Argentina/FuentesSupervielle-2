		...
		if(!requerimientoFormulario.isBuscarElemento() 
			...
			if(result.hasErrors()){
				...
				if("NUEVO".equals(accion)){	
					...
					if (requerimientoFormulario.getTipoRequerimientoCod().toString().equals("14")) {
					
						ScreenMessage notificacion = new ScreenMessageImp("notif.requerimiento.registrado14", Arrays.asList(new String[]{requerimientoFormulario.getSerie().getCodigo() + ": " + requerimientoFormulario.getPrefijoStr()+"-"+requerimientoFormulario.getNumeroStr()}) );
