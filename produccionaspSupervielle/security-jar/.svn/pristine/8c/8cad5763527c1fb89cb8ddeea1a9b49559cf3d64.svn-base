 ...
 *
 */
public class SerieServletPorCodigoReturnPrefijo extends HttpServlet{
	private static final long serialVersionUID = -2135973356955496716L;
	private static Logger logger = Logger.getLogger(SerieServletPorCodigoReturnPrefijo.class);
	...
	public void doGet (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(lista != null){
			respuesta = lista.getPrefijo() + "-" + lista.getUltNroImpreso();
		}else{
			respuesta = "";
		}		
		try {
