 ...
 */
public class SerieServletParaRecibo extends HttpServlet{
	private static final long serialVersionUID = -2135973356955496716L;
	private static Logger logger = Logger.getLogger(SerieServletParaRecibo.class);
...
//		}
	...
	private ClienteEmp serviceObtenerClienteEmp(ClienteEmp clienteEmpBusqueda, ClienteAsp clienteAsp){
		...
		ClienteEmp tipo = service.getByCodigo(clienteEmpBusqueda, clienteAsp);
		if(tipo != null)
			return tipo;
		else
			return null;
