...
public class TipoRequerimiento implements Comparable<TipoRequerimiento>{
	...
	public Boolean getOcultaGrilla() {
		if(ocultaGrilla==null)
			ocultaGrilla=Boolean.FALSE;
		return ocultaGrilla;
	}
	public void setOcultaGrilla(Boolean ocultaGrilla) {
		if(ocultaGrilla==null)
			ocultaGrilla=Boolean.FALSE;
		this.ocultaGrilla = ocultaGrilla;
	}
	@Override
